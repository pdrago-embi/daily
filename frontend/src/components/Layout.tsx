...
export function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className={`min-h-screen transition-colors ${isDark ? 'bg-slate-950' : 'bg-slate-50'}`}>
      ...
      <aside 
        className={`fixed left-0 top-14 bottom-0 border-r transition-all duration-300 z-40 flex flex-col ${
          isDark 
      ...
      >
        <nav className="flex-1 px-2 py-2">
          <div className="space-y-1">
            ...
            >
              ...
              {!sidebarCollapsed && <span>Impressions</span>}
            </Link>
            ...
            >
              ...
              {!sidebarCollapsed && <span>Sasha Balbi</span>}
            </Link>
            ...
            >
              ...
              {!sidebarCollapsed && <span>Embi Media</span>}
            </Link>
          </div>
        </nav>
        ...
        <button
          ...
          className={`p-3 transition-colors border-t ${
            isDark 
      ...
      <main className={`pt-14 transition-all duration-300 ${sidebarCollapsed ? 'pl-16' : 'pl-56'}`}>
        <div className="p-6">
          {children}
        </div>
      </main>
